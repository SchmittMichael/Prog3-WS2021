...
std::string Manager::postReminder(int listId, std::string request) {
    /*
      ...
      std::optional<Reminder> postedReminder = repository.postReminder(listId, Reminder.getTitle(), Reminder.getPos());
      if (postedReminder) {
...
std::string Manager::putReminder(int listId, int reminderId, std::string request) {
    /*
        ...
        Reminder reminder = parsedReminderOptional.value();
        std::optional<Reminder> putReminder = repository.putReminder(listId, remindetId, reminder.getTitle(), reminder.getPos());
