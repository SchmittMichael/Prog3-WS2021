...
class RepositoryIf {
  public:
    ...
    virtual std::optional<ReminderApp::Core::Model::List> getToday() = 0;
    ...
    virtual std::optional<ReminderApp::Core::Model::Reminder> putReminder(int listId, int itemId, std::string title, int position, std::string date, bool flag) = 0;
